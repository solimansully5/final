...
//      home: mainPage(),
//        routes: {
//          '/CoursePageRoute' : (context)=>CoursePage(),
//        }
//    );
//  }
//}
...
class _MainPageState extends State<MainPage> {
        ...
        child: Column(
          ...
          children: <Widget>[
            Row(
              ...
              children: <Widget>[
                Text("'Our Project Name'", style: TextStyle(
                    fontSize: 20,
  ...
  Container courseWidget(String category, String title, String img, Color categoryColor, Color bgColor)
  {
    return Container(
      ...
      child: InkWell(
        onTap: (){
          Navigator.pushNamed(context, StudentsPageRoute);
//          Navigator.pushNamed(context, CoursePageRoute, arguments: [img, title]);
        },
        child: Column(
          crossAxisAlignment: CrossAxisAlignment.start,
          children: <Widget>[
...
//  {
//    Navigator.pushNamed(context, '/CoursePageRoute', arguments: {'img':'$img', 'title':'$title'});
//  }
}
