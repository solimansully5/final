...
class CoursePage extends StatefulWidget {
  ...
  const CoursePage({Key key, this.chosenImg, this.chosenTitle}) : super(key: key);
  @override
...
//    widget.chosenImg = arguments['img'];
    ...
    return Scaffold(
      ...
      body: Container(
        ...
        child: Column(
          ...
          children: <Widget>[
            Text('${widget.chosenTitle}', style: TextStyle(
              color: Color(0xff2657ce),
              fontSize: 27,
            ),),
                ...
                child: Container(
                  ...
                  decoration: BoxDecoration(
                      ...
                      image: DecorationImage(
                        image: AssetImage('assets/image/${widget.chosenImg}.png'),
                      )
                  ),
                ),
              ),
